...
- `AGENTS.md` is the canonical core global agent contract.
- `policies/python-engineering.md` is the canonical concise Python engineering policy.
...
- `~/.codex/AGENTS.md` is generated by composing repository `AGENTS.md` and `policies/python-engineering.md`.
- `~/.agents/AGENTS.md` is generated from the same composed global instructions.
